...
public class AddWord extends JDialog {
	...
	public AddWord() {
		...
		list.setPreferredSize(new Dimension(222, 200));
		listPanel.add(sp);
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Checking that the input when adding a word is correct
				if(!word.equals(" ") && word.matches("^[a-zA-Z]+$")) {
					...
					JOptionPane.showMessageDialog(null, "Please enter valid input.\n"
							+ "(Input can only be letters from the english alphabet");
				}
